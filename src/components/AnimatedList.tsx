    ...
    <div className={`relative w-[500px] ${className}`}>
      <div
        ...
        className={`max-h-[400px] overflow-y-auto p-4 ${
          displayScrollbar
            ? '[&::-webkit-scrollbar]:w-[8px] [&::-webkit-scrollbar-track]:bg-[#120F17] [&::-webkit-scrollbar-thumb]:bg-[#1A1E2B] [&::-webkit-scrollbar-thumb]:rounded-[4px]'
            : 'scrollbar-hide'
        }`}
        onScroll={handleScroll}
        style={{
          scrollbarWidth: displayScrollbar ? 'thin' : 'none',
          scrollbarColor: '#1A1E2B #120F17'
        }}
      >
        {items.map((item, index) => (
          ...
          >
            <div className={`p-4 bg-[#11141A] rounded-lg ${selectedIndex === index ? 'bg-[#1A1E2B]' : ''} ${itemClassName}`}>
